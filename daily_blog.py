...
TOPICS = [
    ...
    },
    {
        ...
        "outline": ["Waarom je huid groen wordt van goedkope ringen", "Welke metalen de boosdoener zijn", "Waarom RVS 316L je vinger NIET groen maakt", "Tips om verkleuring te voorkomen", "Veelgestelde vragen"],
    ...
    },
    {
        ...
        "outline": ["Waarom sieraden dof worden", "RVS sieraden schoonmaken in 3 stappen", "Wat je beter NIET gebruikt (tandpasta, cola)", "Verschil goud, zilver en RVS", "Veelgestelde vragen"],
    ...
    },
    {
        ...
        "outline": ["Wat roestvrij staal precies betekent", "Kan RVS echt roesten?", "Waarom 316L de beste keuze is", "Hoe je je sieraden mooi houdt", "Veelgestelde vragen"],
    ...
    },
    {
        ...
        "outline": ["Wat een nikkelallergie is en hoe je het herkent", "Welke metalen veilig zijn", "Waarom RVS 316L nikkelvrij en hypoallergeen is", "Tips voor gevoelige huid", "Veelgestelde vragen"],
    ...
    },
    {
        ...
        "outline": ["Waarom goed bewaren belangrijk is", "De beste plek (en waarom niet in de badkamer)", "Sieraden apart houden tegen krassen", "RVS is minder onderhoud", "Veelgestelde vragen"],
    ...
    },
    {
        ...
        "outline": ["Wat geboortestenen zijn", "Overzicht: steen per maand en betekenis", "Geboortesteen als persoonlijk cadeau", "Combineren met RVS sieraden", "Veelgestelde vragen"],
    ...
    },
    {
        ...
        "outline": ["Waarom sterrenbeeld-sieraden zo populair zijn", "Wat elk teken symboliseert", "Welk sieraad bij welk teken", "Perfect als persoonlijk cadeau", "Veelgestelde vragen"],
    ...
    },
    {
        ...
        "outline": ["Waarom een initiaal zo persoonlijk is", "Letterketting versus losse letterbedel", "Hoe je het combineert (layering)", "Onderhoudsvrij in RVS", "Veelgestelde vragen"],
    ...
    },
    {
        ...
        "outline": ["Waarom de juiste ringmaat belangrijk is", "Meten met een touwtje of strip papier", "Ringmaat-tabel (omtrek naar maat)", "Tips bij verstelbare ringen", "Veelgestelde vragen"],
    ...
    },
    {
        ...
        "outline": ["Waarom de juiste maat comfortabel zit", "Je pols meten in 2 stappen", "Hoeveel ruimte je toevoegt", "Bangle versus schakelarmband", "Veelgestelde vragen"],
        "cta_text": "Bekijk onze armbanden",
        "cta_url": "/collections/armbanden",
    },
    {
        ...
        "outline": ["Waarom halslijn en kettinglengte samenhangen", "Ketting bij een ronde hals", "Ketting bij een V-hals of lage hals", "Layeren voor extra effect", "Veelgestelde vragen"],
        "cta_text": "Bekijk onze kettingen",
        "cta_url": "/collections/kettingen",
    },
    {
        ...
        "outline": ["Waarom prijs niet alles zegt", "Waaraan je kwaliteit herkent", "Waarom RVS er luxe uitziet en blijft", "Stylingtips voor een dure uitstraling", "Veelgestelde vragen"],
        "cta_text": "Bekijk onze betaalbare RVS sieraden",
        "cta_url": "/collections/alle-sieraden",
    },
    {
        ...
        "outline": ["Wat gold plated precies is", "Waarom een dunne goudlaag slijt", "Hoe je verkleuring vertraagt", "Waarom RVS niet verkleurt", "Veelgestelde vragen"],
    ...
    },
    {
        ...
        "outline": ["Waarom sieraden een persoonlijk cadeau zijn", "Ideeen per type vriendin", "Matching sieraden voor BFFs", "Betaalbaar en toch bijzonder", "Veelgestelde vragen"],
    ...
    },
    {
        ...
        "outline": ["Waarom persoonlijk wint van duur", "Sieraden met betekenis (geboortesteen, initiaal)", "Tijdloze keuzes die ze echt draagt", "Onderhoudsvrij in RVS", "Veelgestelde vragen"],
        "cta_text": "Bekijk onze sieraden",
        "cta_url": "/collections/alle-sieraden",
    },
    {
        ...
        "outline": ["De geschiedenis en betekenis van het enkelbandje", "Aan welke enkel draag je het", "Stylingtips voor de zomer", "Waterproof RVS voor strand en zwembad", "Veelgestelde vragen"],
        "cta_text": "Bekijk onze enkelbandjes",
        "cta_url": "/collections/alle-sieraden",
    },
    {
        ...
        "outline": ["De ongeschreven regels voor gasten", "Subtiel versus statement", "Matchen met je outfit", "Tijdloze keuzes die altijd passen", "Veelgestelde vragen"],
        "cta_text": "Bekijk onze sieraden",
        "cta_url": "/collections/alle-sieraden",
    },
    {
        ...
        "outline": ["De grootste zomertrends van 2026", "Kleuren en materialen die opvallen", "Waterproof sieraden voor vakantie", "Hoe je de trends draagt", "Veelgestelde vragen"],
